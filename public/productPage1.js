...
const editProduct = async () => {
    try {
        ...
        const newWeight = prompt('Enter new weight:', product.weight);
        const newCategory = prompt('Enter new category:', product.category);
        const newQuantityInStore = prompt('Enter new quantity in store:', product.quantityinstore);
        const newQuantityInWarehouse = prompt('Enter new quantity in warehouse:', product.quantityinwarehouse);
        const newSafetyStockLevel = prompt('Enter new safety stock level:', product.safetystocklevel);
        const newDemandRateInput = prompt('Enter new demand rate input:', product.demandRateInput);
        const newLeadTime = prompt('Enter new lead time:', product.leadTime);
        const newStdDeviation = prompt('Enter new standard deviation:', product.stdDeviation);
        const newServiceLevel = prompt('Enter new service level:', product.serviceLevel);
        const newZScore = prompt('Enter new Z-score:', product.zScore);
        ...
        product.quantityinstore = newQuantityInStore;
        product.quantityinwarehouse = newQuantityInWarehouse;
        product.safetystocklevel = newSafetyStockLevel;
        product.demandRateInput = newDemandRateInput;
        product.leadTime = newLeadTime;
        product.stdDeviation = newStdDeviation;
        product.serviceLevel = newServiceLevel;
        product.zScore = newZScore;
